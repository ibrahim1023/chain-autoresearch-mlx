...
contract RewardDistributorManualComparatorInvariantTest {
    RewardDistributorManualComparator internal distributor;
    address[] internal accounts;

    function setUp() public {
        distributor = new RewardDistributorManualComparator();
